...
export default function BrandVault({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      // Destroying the loading task also disposes its loaded document.
      // Calling destroy on both objects during a project switch can race
      // and crash the entire React tree in PDF.js 6.
      if (
    ...
    >
      ...
      <header className="brand-vault-header">
        ...
        <div className="brand-vault-tools">
          <a
            className="brand-vault-pdf-link"
            href={project.pdf}
            target="_blank"
            rel="noreferrer"
            aria-label={`Open the complete ${project.title} PDF in a new tab`}
          >
            Open PDF
          ...
          >
            ...
            {loadState === 'error' && (
              <div className="brand-vault-error">
                ...
                <span>
                  The interactive reader is unavailable,
                  but the complete guide can still be opened.
                </span>
